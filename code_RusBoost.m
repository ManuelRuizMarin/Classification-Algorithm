function [trainedClassifier,validationPredictions, validationAccuracy] = code_RusBoost(trainingData)
% 
% returns a trained classifier, predictions and its accuracy. 
%  Input:
%      trainingData: a matrix with the same number of columns and data type
%       as in feature extraction 
%
%  Output:
